class PPdefinitions(object):
    DEFINITIONS_VERSION_STRING='1.5.3'
    ...
    show_types={
        ...
        'artliveshow':[
            ...
            'tab-tracks','sep',
                ...
                'mpv-audio','mpv-volume','mpv-window','mpv-aspect-mode','mpv-freeze-at-start','mpv-freeze-at-end','mpv-other-options','sep',
    ...
    new_shows={
                ...
                'artliveshow':{'title': 'New ArtLiveshow','show-ref':'','show-canvas':'', 'display-name':'HDMI0', 'type': 'artliveshow', 'disable-controls':'no','sequence': 'ordered','repeat':'repeat','medialist': '',
                       ...
                       'show-text-type':'text','show-html-width':'300','show-html-height':'300','show-html-background-colour':'white','show-text-location':'',
                         ...
                         'transition': 'cut', 'duration': '5','pause-timeout':'','image-window':'original','image-rotate':'0','audio-speaker':'stereo','mplayer-audio':'hdmi','mplayer-volume':'100','mplayer-other-options':'',

                            'mpv-audio': 'hdmi','mpv-volume':'100','mpv-window':'showcanvas 200+200+400*300','mpv-other-options':'','mpv-aspect-mode':'original',
                    ...
                    'links':'','first-track-ref':'','home-track-ref':'','timeout-track-ref':'','disable-controls':'no','show-timeout': '0','track-timeout': '0',
                       ...
                       'show-text-type':'text','show-html-width':'300','show-html-height':'300','show-html-background-colour':'white','show-text-location':'',
                            ...
                            'transition': 'cut', 'duration': '0','pause-timeout':'','image-window':'original','image-rotate':'0',
                             'audio-speaker':'stereo','mplayer-audio':'hdmi','mplayer-volume':'100','mplayer-other-options':'',
    ...
    track_types={
            ...
            'mpv':[
            'tab-track','sep',  
                    'type','title','track-ref','location','thumbnail','mpv-audio','mpv-volume','mpv-max-volume',
                    'mpv-window','mpv-aspect-mode','mpv-subtitles','mpv-freeze-at-start','mpv-freeze-at-end','mpv-other-options',
    ...
    new_tracks={
                ...
                'mpv':{'title':'New MPV Video','track-ref':'','type':'mpv','location':'','thumbnail':'',
                         'mpv-audio':'','mpv-volume':'','mpv-max-volume':'','mpv-window':'','mpv-other-options': '','mpv-aspect-mode':'',
                         'mpv-subtitles':'no',
                         'mpv-freeze-at-start':'','mpv-freeze-at-end':'',
